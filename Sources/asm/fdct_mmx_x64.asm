...
%define OUT_5 rcx + 80
%define OUT_6 rcx + 96
%define OUT_7 rcx + 112
%define OUT_8 rcx + 128

%define TABLE_1 rbx + 64
%define TABLE_2 rbx + 128
%define TABLE_3 rbx + 192
%define TABLE_4 rbx + 256
%define TABLE_5 rbx + 320
%define TABLE_6 rbx + 384
%define TABLE_7 rbx + 448
...
;--------------------- columns
	...
	lea	r9, [tab_frw_01234567]
	mov TABLEF, r9				; row 0
	mov OUT, INP

	lea r9, [r_frw_row]
	mov round_frw_row, r9
...
[endprolog]
        ...
        transpose8x8sse2        rax,rbx,1  ; First we transpose last 4 lines
        transpose8x8sse2        rax,rbx,0  ; Then the firts 4 lines

	;processing columns (became rows after transposition)

        FDCT_1D rbx,rax,0,CONST_BITS - PASS1_BITS

        transpose8x8sse2        rax,rbx,1
        transpose8x8sse2        rax,rbx,0

	;now processing rows

        FDCT_1D rbx,rax,1,CONST_BITS + PASS1_BITS + 3
